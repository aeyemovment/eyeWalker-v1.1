# eyeWalker v1.1.9 (Codex rereview release-candidate fixes)
...
- Remove remaining private-lane, dual-use, and unsupported privacy/security claims from the tracked public tree
...
- Remove legacy non-synthetic media from the candidate tip. Existing commits and immutable tags were not rewritten and may still retain those historical objects; this is not a historical-purge claim. Any history remediation requires a separate human/legal decision.
...
- Scrub dual-use / private-lane / fake-crypto presentation from the public tree
