# Public / open source status — eyeWalker v1.1
...
- **Public** = code on the open internet; no login required to read/clone.  
- **Open source (OSI)** = MIT portions allow commercial use under MIT.  
- **PolyForm Noncommercial** = source-available for noncommercial use of the **core**; commercial productization of core needs a separate license (issue tag `commercial-license`).
